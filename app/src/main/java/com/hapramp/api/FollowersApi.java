...
public class FollowersApi {
  ...
  public FollowersApi(Context context) {
    this.context = context;
    this.mHandler = new Handler();
  }

  public void setFollowingCallback(FollowerCallback followerCallback) {
    this.followerCallback = followerCallback;
  }


  public void requestFollowers(final String username, final String startFromUser) {
    final String rtag = "followers_" + username + "_" + startFromUser;
  ...
  private void parseFollowers(String response, String rtag) {
    ...
    if (isRequestLive(rtag)) {
      if (followerCallback != null) {
        followerCallback.onFollowers(followers);
      }
    }
  }
  ...
  public interface FollowerCallback {
    void onFollowers(ArrayList<String> followers);
