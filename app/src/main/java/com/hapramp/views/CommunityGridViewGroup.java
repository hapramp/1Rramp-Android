...
public class CommunityGridViewGroup extends ViewGroup {
  private int mCols = 3;
  ...
  public CommunityGridViewGroup(Context context) {
    super(context);
    init(context);
  }
  ...
  public CommunityGridViewGroup(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context);
  }

  public CommunityGridViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public void setChildInfo(int cols, int childs) {
    this.mCols = cols;
    verticalSpaceBetweenChild = PixelUtils.dpToPx(33);
    horizontalSpaceBetweenChild = PixelUtils.dpToPx(30);
    singleChildHeight = PixelUtils.dpToPx(104);
    singleChildWidth = PixelUtils.dpToPx(80);
