...
import com.hapramp.chat.services.DispatchService;
import com.hapramp.logger.L;

import java.util.ArrayList;

import static com.hapramp.chat.database.DatabaseContract.DB_NAME;
import static com.hapramp.chat.database.DatabaseContract.DB_VERSION;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static DatabaseHelper getInstance(){
        if(mInstance==null){
            mInstance = new DatabaseHelper(HapRampMain.getContext());
        }
        return mInstance;
    }
    ...
    public DatabaseHelper(Context context) {
        ...
        getWritableDatabase();
        context = HapRampMain.getContext();
    }
